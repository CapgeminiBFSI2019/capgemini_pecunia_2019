...
public class Values {
	...
	public static final String TRANSACTION_OPTION_1 = "SLIP";
	public static final String TRANSACTION_OPTION_2 = "CHEQUE";
	public static final String[] OTHER_BANK_NAME = {"ICICI","SBI","HDFC","KOTAK","AXIS"};
	public static final String CHEQUE_STATUS_1 = "PENDING";
	public static final String CHEQUE_STATUS_2 = "CLEARED";
	public static final String CHEQUE_STATUS_3 = "BOUNCED";
